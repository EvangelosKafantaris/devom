function [Out_DispEn, npdf]=AltMetDisEn(x,m,nc,MA,tau)
%% This is an implementation of the Alernative Statistical Metrics Dispersion Entropy
% (AltMetDisEn) which is a variation of the original Dispersion Entropy algorithm.

% The AltMetDisEn variation uses alternative statistical metrics for the implementation 
% of mapping functions. The originally used mean is replaced with median and standard deviation
% is estimated using the median absolute deviation multiplied by the scaling factor of 1.4826.
% The new statistical metrics are chosen for their robustness to outliers.
...
% The following two lines calculate the alternative statistical metrics as
% outlined in the description
sigma_x = 1.4826 * mad(x);
mu_x = median(x);
