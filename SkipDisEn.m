function [Out_DispEn, npdf]=SkipDisEn(x,m,nc,MA,tau)
%% This is an implementation of the Skip Sample Dispersion Entropy (SkipDisEn)
% which is a variation of the original Dispersion Entropy algorithm.

% The SkipDisEn variation removes samples marked as missing (NaN) and
% connects the remaining samples in a continuous time-series. 

% This variation was produced by 
% Evangelos Kafantaris and Javier Escudero
% evangelos.kafantaris@ed.ac.uk, javier.escudero@ed.ac.uk
% 09/08/2019
...
%%
% The following line is introduced for the SkipDisEn variation and 
% adds the respective sample skipping mechanism 
x = x(~isnan(x));
